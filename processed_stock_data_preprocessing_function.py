"""
   Used for as part of the ydata_synthetic library, source: https://github.com/ydataai/ydata-synthetic/blob/dev/src/ydata_synthetic/preprocessing/timeseries/utils.py
"""
import numpy as np
